...
const Home = () => {
  ...
  const PHONE = "(312) 981-9410";
  const EMAIL = "PAYROCKLOGISTICS@GMAIL.COM";
  const MC_NUMBER = "1598388";
  const DOT_NUMBER = "4159723";
  const HOME_BASE = "6348 S PAULINA CHICAGO, IL 60636";
  ...
  const handleDownload = (docName) => {
    ...
    fetch(filePath)
      ...
      .then(blob => {
        ...
        link.href = url;
        link.setAttribute('download', `${docName.replace(/\s+/g, '_')}_PPL.jpg`);
  ...
  const handleUnlock = (e) => {
    e.preventDefault();
    if (accessCode.toUpperCase() === 'PPL2026') {
      setIsUnlocked(true); 
      setShowModal(false); 
      setError('');
    } else { 
      setError('Invalid Code. Try "PPL2026"'); 
    }
  };
  ...
  const handleQuoteRequest = (e) => {
    ...
    const subject = encodeURIComponent(`Quote Request: ${quoteOrigin} to ${quoteDest} - PAY ROCK LOGISTICS LLC`);
    const body = encodeURIComponent(
      `Hi Richard,\n\nI am reaching out to request a quote for a load moving from ${quoteOrigin} to ${quoteDest}.\n\nEquipment Required: 26ft Box Truck\nCarrier: PAY ROCK LOGISTICS LLC (MC# ${MC_NUMBER})\n\nPlease let me know your availability and rate for this lane.\n\nBest regards,`
    );
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up z-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-none tracking-tight text-gray-900">
              <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-red-400">PAY ROCK</span><br /> LOGISTICS LLC
            </h1>
          ...
          <div className="relative w-full h-full animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            <div className="clip-trap relative z-10 bg-gray-800 aspect-[4/5] shadow-2xl group overflow-hidden">
              <img 
                src={heroTruck} 
                alt="Richard Trucking LLC 26ft International Box Truck" 
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
           {/* Image Side */}
            <div className="relative group hover-lift">
              ...
              <img 
                src={driverImg} 
                alt="Richard Barber - Owner Operator" 
              ...
              <div className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-md px-6 py-4 border-l-4 border-red-600 shadow-lg">
                <p className="font-black text-xl uppercase text-white">Richard Barber</p>
          ...
          <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed border-l-4 border-red-200 pl-4">
                "I operate under my own authority to kill the anxiety brokers feel when they hang up the phone. When you book PAY ROCK LOGISTICS LLC, you aren't talking to a dispatcher—you're talking to the driver. 
                <br/><br/>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="relative group clip-trap bg-gray-200 shadow-xl overflow-hidden h-[400px] lg:h-auto">
              <img 
                src={truckRear} 
                alt="Richard's 3000lb Anthony Liftgate Proof" 
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
              />
      ...
      <section className="py-20 bg-gray-900 text-white clip-angle">
        <div className="max-w-7xl mx-auto px-4">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { name: "Jason M.", company: "TQL", text: "Richard was excellent. Perfect for that tricky LTL run we had. Tracking was on point." },
      ...
      <section id="lanes" className="py-20 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['ILLINOIS', 'INDIANA', 'WISCONSIN', 'MICHIGAN', 'IOWA', 'MISSOURI', 'OHIO', 'MINNESOTA'].map((state, index) => (
                <span 
                  key={state} 
